...
<div class="row">
		<center><h3 class="text text-primary">Student Not Pay Second Term Level3 SOD</h3></center>	
		<div class="col-md-12">
			
<form action="search_notpaysecond3sod.php" method="GET">
	...
	$select=mysqli_query($conn,"SELECT second_id,student_code,firstname,lastname,ammount,paid,total FROM student RIGHT JOIN second_term ON student.st_id = second_term.st_id WHERE department_name='SOD' AND level='l3' AND total>0");
