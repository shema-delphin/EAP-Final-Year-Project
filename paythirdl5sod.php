...
<div class="row">
		<center><h3 class="text text-primary">Student Pay Third Term Level5 SOD</h3></center>	
		<div class="col-md-12">
			
<form action="search_paythird5sod.php" method="GET">
	...
	$select=mysqli_query($conn,"SELECT third_id,student_code,firstname,lastname,ammount,paid,total FROM student RIGHT JOIN third_term ON student.st_id = third_term.st_id WHERE department_name='SOD' AND level='l5' AND total=0");
