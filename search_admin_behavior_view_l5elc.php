...
<form action="search_admin_behavior_view_l5elc.php" method="GET">
	...
	$select=mysqli_query($conn,"SELECT student_code,firstname,lastname,behavior_first_marks,behavior_second_marks,behavior_third_marks from student right join behavior on student.st_id=behavior.st_id WHERE department_name='ELC' AND level='L5'AND student_code LIKE '%$student_code%'");
