...
<form action="search_parent.php" method="GET">
...
<table class="table table-striped table-sm">
	...
	$select=mysqli_query($conn,"SELECT par_id,student_code,fathername,fatherphone,fathernid,fatherdob,mathername,matherphone,mathernid,matherdob from student right join parents on student.st_id=parents.st_id WHERE student_code LIKE '%$student_code%';");
	...
	if ($num>0) {
		...
		<tr>
			...
			<td><a onclick="return confirm('Are you Sure you want to Delete?'); " class="btn btn-danger" href="pardelete.php?par_id=<?php echo $data['par_id'] ?>">Delete</a></td>
			<td><a class="btn btn-success" href="parupdate.php? par_id=<?php echo $data['par_id'] ?>">Update</a></td>
