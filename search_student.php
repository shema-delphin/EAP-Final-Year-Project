...
<div class="row">
		<center><h3 class="text text-primary">Students View</h3></center>
		<div class="col-md-12">
...
<form action="search_student.php" method="GET">
	...
	$select=mysqli_query($conn,"SELECT * FROM student WHERE student_code LIKE '%$student_code%'");
	...
	if ($num>0) {
		...
		<tr>
			...
			<td><?php echo $data['level4'] ?></td>
			<td><?php echo $data['level5'] ?></td>
			<td><?php echo $data['position'] ?></td>
			
			<td><a onclick="return confirm('Are you Sure you want to Delete?'); " class="btn btn-danger" href="stdelete.php?st_id=<?php echo $data['st_id'] ?>">Delete</a></td>
			<td><a class="btn btn-success" href="stupdate.php? st_id=<?php echo $data['st_id'] ?>">Update</a></td>
