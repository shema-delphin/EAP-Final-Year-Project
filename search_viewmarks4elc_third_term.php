...
<div class="row">
		<center><h3 class="text text-primary">Marks View Third Term Level4 ELC</h3></center>	
		<div class="col-md-12">
			
<form action="search_viewmarks4elc_third_term.php" method="GET">
	...
	$select=mysqli_query($conn,"SELECT * FROM sub33 WHERE department_name='ELC' AND level='L4' AND student_code LIKE '%$student_code%'");
	...
	if ($num>0) {
		...
		<tr>
			...
			<td><a onclick="return confirm('Are you Sure you want to Delete?'); " class="btn btn-danger" href="deletemarksl4elc_third_term.php?marks_id=<?php echo $data['marks_id'] ?>">Delete</a></td>

			<td><a class="btn btn-success" href="updatemarksl4elc_third_term.php? marks_id=<?php echo $data['marks_id'] ?>">Update</a></td>
