...
<form action="search_viewreport3sod_third_term.php" method="GET">
	...
	$select=mysqli_query($conn,"SELECT st_id,student_code,firstname,lastname FROM report_third WHERE total=0 AND department_name='SOD' AND level='L3' GROUP BY st_id AND student_code LIKE '%$student_code%'");
