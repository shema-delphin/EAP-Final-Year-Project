...
<form action="search_viewsecond4elc.php" method="GET">
	...
	$select=mysqli_query($conn,"SELECT second_id,student_code,firstname,lastname,ammount,paid,total FROM student RIGHT JOIN second_term ON student.st_id = second_term.st_id WHERE department_name='ELC' AND level='l4' AND student_code LIKE '%$student_code%'");
