...
<form action="" method="POST">
				...
				<div class="card-header">
					<center><h3 class="text text-primary">Third Term Payment L3 ELC</h3></center>
				</div><br>
				<div class="card-body">
					Student Id
					...
					<option>Select Student Id</option>						
                        ...
                        $select="SELECT st_id,student_code,firstname,lastname,position FROM student WHERE department='ELC' AND level3='L3'";
...
if ($paid <= $ammount && $paid>0) {
	...
	$insert=mysqli_query($conn,"INSERT INTO third_term VALUES('','$st_id','$department_name','$level','$ammount','$paid','$total')");
if ($insert==1) {
