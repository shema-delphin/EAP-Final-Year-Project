...
<form action="" method="POST">
				...
				<div class="card-header">
					<center><h3 class="text text-primary">Third Term Payment L3 SOD</h3></center>
				</div><br>
				<div class="card-body">
					Student Id
					...
					<option>Select Student Id</option>						
                        ...
                        $select="SELECT st_id,student_code,firstname,lastname,position FROM student WHERE department='SOD' AND level3='L3'";
