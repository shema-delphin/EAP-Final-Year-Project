...
$select=mysqli_query($conn,"SELECT * FROM first_term WHERE first_id='$first_id'");
...
<form action="upfirstl4sod.php" method="POST">
				
				<div class="card">
				<div class="card-header">
					<center><h3 class="text text-primary">Update First Term Level 4 SOD</h3></center>
				</div>
				<div class="card-body">
First Term Id				
<input type="number" name="first_id" readonly class="form-control" value="<?php echo $first_id ?>">				
<br>
Student Id
