...
$select=mysqli_query($conn,"SELECT * FROM marks_second_term WHERE marks_id='$marks_id'");
...
<form action="upmarksl3elc_second_term.php" method="POST">
				<br>
				<div class="card">
				<div class="card-header">
					<center><h3 class="text text-primary">Update Marks Second Term Level3 ELC</h3></center>
				</div><br>
				<div class="card-body">
					Id
