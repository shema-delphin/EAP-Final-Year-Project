...
$select=mysqli_query($conn,"SELECT * FROM marks_third_term WHERE marks_id='$marks_id'");
...
<form action="upmarksl5sod_third_term.php" method="POST">
				<br>
				<div class="card">
				<div class="card-header">
					<center><h3 class="text text-primary">Update Marks Third Term Level5 SOD</h3></center>
				</div><br>
				<div class="card-body">
					Id
