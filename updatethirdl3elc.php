...
$select=mysqli_query($conn,"SELECT * FROM third_term WHERE third_id='$third_id'");
...
<form action="upthirdl3elc.php" method="POST">
				
				<div class="card">
				<div class="card-header">
					<center><h3 class="text text-primary">Update third Term Level 3 ELC</h3></center>
				</div>
				<div class="card-body">
third Term Id				
<input type="number" name="third_id" readonly class="form-control" value="<?php echo $third_id ?>">				
<br>
Student Id
