...
$update=mysqli_query($conn,"UPDATE marks_third_term SET department_name='$department_name', level='$level', st_id='$st_id', module_id='$module_id', formative='$formative', summative='$summative', total_marks='$total_marks' WHERE marks_id='$marks_id'");

	if ($update==1) {
		include 'viewmarksl5sod_third_term.php';
	}else{
