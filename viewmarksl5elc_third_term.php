...
<form action="search_viewmarks5elc_third_term.php" method="GET">
	...
	$select=mysqli_query($conn,"SELECT * FROM sub33 WHERE department_name='ELC' AND level='L5'");
	...
	if ($num>0) {
		...
		<tr>
			...
			<td><a onclick="return confirm('Are you Sure you want to Delete?'); " class="btn btn-danger" href="deletemarksl5elc_third_term.php?marks_id=<?php echo $data['marks_id'] ?>">Delete</a></td>

			<td><a class="btn btn-success" href="updatemarksl5elc_third_term.php? marks_id=<?php echo $data['marks_id'] ?>">Update</a></td>
