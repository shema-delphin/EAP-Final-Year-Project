...
<table class="table table-striped table-sm">
	...
	$select=mysqli_query($conn,"SELECT par_id,student_code,fathername,fatherphone,fathernid,fatherdob,mathername,matherphone,mathernid,matherdob,emergency from student right join parents on student.st_id=parents.st_id;");
