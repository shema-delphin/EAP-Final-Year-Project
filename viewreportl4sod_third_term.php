...
<form action="search_viewreport4sod_third_term.php" method="GET">
	...
	$select=mysqli_query($conn,"SELECT st_id,student_code,firstname,lastname FROM report_third WHERE total=0 AND department_name='SOD' AND level='L4' GROUP BY st_id");
	...
	if ($num>0) {
		...
		<tr>
			...
			<td><a class="btn btn-success" href="bulkerApiHundler.php?action=sendBulkerSODLV4SM3&studentId=<?php echo $data['st_id'] ?>">Send SMS</a></td>
